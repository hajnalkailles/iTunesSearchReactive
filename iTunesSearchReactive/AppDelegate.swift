...
//
//  Created by Hajnalka Hegyi on 2016. 11. 01..
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidFinishLaunching(application: UIApplication) {
        ...
        let viewModel = iTunesSearchViewModel(service: navigationService)
        
        let storyBoard : UIStoryboard = UIStoryboard(name: mainStoryboardName, bundle:nil)
        let nextViewController = storyBoard.instantiateViewControllerWithIdentifier("iTunesSearchViewController") as! iTunesSearchViewController
